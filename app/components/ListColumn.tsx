      ...
      <div className="flex justify-between items-center mb-2">
        {editMode ? (
          <div className="flex gap-1 w-full">
            ...
            <button onClick={handleEditList} className="p-1 rounded hover:bg-green-200" title="Save">
              <svg
            ...
            <button onClick={() => setEditMode(false)} className="p-1 rounded hover:bg-gray-200" title="Cancel">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
          ...
          <>
            <h3 className="font-bold truncate max-w-[150px]" title={listName}>
              {listName}
            </h3>
            <div className="flex gap-1">
              <button onClick={() => setEditMode(true)} className="p-1 rounded hover:bg-gray-200" title="Edit List">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                ...
                >
                  <path
                    ...
                    d="M16.862 3.487l3.651 3.65-10.607 10.607H6.255v-3.651l10.607-10.607z"
                  />
                </svg>
              </button>

              <button onClick={handleDeleteList} className="p-1 rounded hover:bg-red-200" title="Delete List">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
